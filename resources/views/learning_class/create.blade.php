                    ...
                    <div class="max-w-xl">
                        ...
                        <div class="py-2">
                            ...
                            <div class="flex items-center mb-2">
                                <input type="checkbox" name='students[]' value={{$student->id}} class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for={{$student->id}} class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{$student->last_name . ' ' . $student->first_name . ' ' . $student->father_name}}</label>
                            </div>
                            @endforeach
                        </div>
                    </div>
                ...
                <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                    <div class="max-w-xl">
                        ...
                        <div class="py-2">
                            ...
                            <div class="flex items-center mb-2">
                                <input type="checkbox" name='disciplines[]' value={{$discipline->id}} class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for={{$discipline->id}} class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{$discipline->name}}</label>
                            </div>
                            @endforeach
                        </div>
                    </div>
